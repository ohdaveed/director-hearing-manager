...
function FormPage1(p: PrintFormProps) {
  ...
  const earliestDueDate = filled.reduce(
    (min, v) => (!min || v.dueDate < min ? v.dueDate : min),
    "",
  );
  ...
  if (p.isHealthyHousing && p.currentBalance) {
    ...
    obsLines.push(
      "(Reinspections after the first are charged at $229/hour per SFHC Art. 11, Sec. 609)",
    );
  }
          ...
          <tr>
            ...
            <td style={{ ...cellBase, width: "26%", padding: "4px 8px" }}>
              <div style={{ marginBottom: 3 }}>
                Date: <strong>{fmtDate(p.inspectionDate)}</strong>
              </div>
              <div style={{ marginBottom: 3 }}>
                Time in w/ travel: <strong>{fmtTime(p.timeIn)}</strong>
              </div>
              <div>
                Time out: <strong>{fmtTime(p.timeOut)}</strong>
              </div>
            </td>
          </tr>
        </tbody>
        ...
        <tbody>
          <tr>
            <td style={{ ...cellBase, width: "45%" }}>
              <strong>Location Address:</strong> {p.facilityName}
            </td>
            <td style={{ ...cellBase, width: "30%" }}>
              <strong>Contact Phone(s):</strong> {p.contactPhone}
            </td>
            <td style={{ ...cellBase, width: "25%" }}>
              <strong>Location ID:</strong> {p.locationId}
            </td>
          </tr>
          <tr>
            <td style={cellBase}>
              <strong>DBA:</strong> {p.reportTitle}
            </td>
            <td style={cellBase}>&nbsp;</td>
            <td style={cellBase}>
              <strong>Complaint ID:</strong> {p.complaintId}
            </td>
          </tr>
          <tr>
            <td style={cellBase}>
              <strong>Management Name:</strong> {p.ownerName}
            </td>
            <td style={cellBase}>
              <strong>Contact Email(s):</strong> {p.contactEmail}
            </td>
            <td style={cellBase}>
              <strong>Re-inspection On/After:</strong> {fmtDate(reinspDate)}
            </td>
          </tr>
          <tr>
            <td style={cellBase} colSpan={3}>
              <strong>Owner&apos;s Name:</strong> {p.ownerName}
            </td>
          </tr>
        </tbody>
      </table>
              ...
              >
                <span
                  style={{
                    ...
                    height: 9,
                    border: "1px solid #000",
                    background: p.isHealthyHousing ? "#333" : "#fff",
      ...
      >
        <tbody>
          <tr>
            ...
            <td style={cellCenter} colSpan={2}>
              <strong>Inspection Rating</strong>
            </td>
            <td style={cellCenter}>
              <strong>Vector Survey</strong>
            </td>
          </tr>
          <tr>
            <td style={cellBase}>
              <Cb checked={p.inspectionType === "Routine"} label="Routine" />
            </td>
            <td style={cellBase}>
              <Cb
                checked={p.inspectionType === "Routine Re-inspection"}
                label="Routine Re-inspection"
              />
            </td>
            <td style={cellBase} colSpan={2}>
              <Cb
                checked={p.inspectionType === "Citation to Hearing Issued"}
                label="Citation to Hearing Issued"
              />
            </td>
            <td style={cellBase}>
              <Cb
          ...
          <tr>
            ...
            <td style={cellBase}>
              <Cb
                checked={p.inspectionType === "Complaint Re-inspection"}
                label="Complaint Re-inspection"
              />
            </td>
            <td style={cellBase} colSpan={2}>
              <Cb
                checked={p.inspectionType === "Field Consultation / Survey"}
                label="Field Consultation / Survey"
              />
            </td>
            <td style={cellBase} colSpan={3}>
              &nbsp;
      ...
      >
        <tbody>
          <tr>
            ...
            <td style={cellCenter} colSpan={2}>
              <strong>Violation Category (Article 11)</strong>
            </td>
          </tr>
          <tr>
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <Cb
                      checked={
                        hasLoc("bathroom", "toilet", "restroom") ||
                        hasA("Bathrooms / Plumbing Areas")
                      }
                      label="Bathroom"
                    />
                    <Cb
            ...
            <td style={{ ...cellBase, width: "42%", verticalAlign: "top" }}>
              ...
              />
              <Cb
                checked={hasV("Human / Animal Waste")}
        ...
        <tbody>
          <tr>
            <td style={{ ...cellBase, width: "60%" }}>
              <strong>Inspector/Investigator Name:</strong> {p.inspector}
            </td>
            <td style={cellBase}>
              <strong>Office Phone Number:</strong> (415) 252-3800
            </td>
          </tr>
          <tr>
            <td style={{ ...cellBase, paddingTop: 12 }}>
              <strong>Inspector/Investigator Signature:</strong>
            </td>
            <td style={{ ...cellBase, paddingTop: 12 }}>
...
const CODE_ROWS: CodeRow[] = [
  {
    header: true,
    dark: true,
    sec: "SAN FRANCISCO HEALTH CODE ARTICLE 11 CODE SECTIONS",
  },
  { header: true, sec: "PROHIBITED PUBLIC HEALTH NUISANCES" },
  {
    sec: "Sec. 581 (a)",
    text: "No Person shall have upon any premises or real property owned, occupied or controlled by him, or her, or it any public nuisance.",
  },
  {
    sec: "Sec. 581 (b)(1)",
    text: "Any accumulation of filth, garbage, decayed or spoiled food, unsanitary debris or waste material or decaying animal or vegetable matter unless such materials are set out for collection in compliance with Section 283 of this Code;",
  },
  {
    sec: "Sec. 581 (b)(2)",
    text: "Any accumulation of hay, grass, straw, weeds, or vegetation overgrowth;",
  },
  {
    sec: "Sec. 581 (b)(3)",
    text: "Any accumulation of waste paper, litter or combustible trash unless such materials are set out for collection in compliance with Section 283 of this Code;",
  },
  {
    sec: "Sec. 581 (b)(4)",
    text: "Any buildings, structures, or portion thereof found to be unsanitary;",
  },
  {
    sec: "Sec. 581 (b)(5)",
    text: "Any matter or material which constitutes, or is contaminated by, animal or human excrement, urine or other biological fluids;",
  },
  {
    sec: "Sec. 581 (b)(6)",
    text: "Any visible or otherwise demonstrable mold or mildew in the interiors of any buildings or facilities;",
  },
  {
    sec: "Sec. 581 (b)(7)",
    text: "Any pest harborage or infestation including but not limited to pigeons, skunks, raccoons, opossums, and snakes, except for pigeon harborages that comply with Section 37(e) of this Code;",
  },
  {
    sec: "Sec. 581 (b)(8)",
    text: "Any noxious insect harborage or infestation including, but not limited to cockroaches, bed bugs, fleas, scabies, lice, spiders or other arachnids, houseflies, wasps and mosquitoes, except for harborages for honey-producing bees regulated by the California Food and Agriculture Code Sections 29000 et seq.",
  },
  {
    sec: "Sec. 581 (b)(9)",
    text: "Any article of food or drink in the possession or under the control of any person which is tainted, decayed, spoiled or otherwise unwholesome or unfit to be eaten or drunk.",
  },
  {
    sec: "Sec. 581 (b)(11)",
    text: "Any vacant lots, open spaces, and other properties in the City and County of San Francisco, which become infested with poison oak (Toxicodendron diversilobum) or poison ivy shrub (Rhus toxicodendron) hereafter referred to as poisonous growth;",
  },
  {
    sec: "Sec. 581 (b)(12)",
    text: "Any violation of Section 37 of this Code; [Article 1]",
  },
  {
    sec: "Sec. 581 (b)(13)",
    text: "Any violation of Section 92 of this Code; [Article 2]",
  },
  {
    sec: "Sec. 581 (b)(14)",
    text: "Any violation of Section 590 of this Article;",
  },
  {
    sec: "Sec. 581 (b)(17)",
    text: "Any violations of rules or regulations the Director adopts to implement the provisions of this Article or applicable provisions of State law.",
  },
  {
    sec: "Sec. 581 (b)(18)",
    text: "Anything else that the Director deems to be a threat to public health and safety.",
  },
  {
    sec: "Sec. 609 (a) et seq.",
    text: "Vector Control And Healthy Housing Inspection Program Fee. Every owner of an apartment house or hotel shall pay an annual fee to the Department. The amount of the fee shall be determined by the number of rental units in the building.",
  },
  {
    header: true,
    sec: "NOTICE OF VIOLATION & CONSEQUENCES OF FAILURE TO TIMELY ABATE",
  },
  {
    sec: "Sec. 596 (b).",
    text: "Whenever the Director determines that a nuisance exists, the Director shall within 15 days cause a Notice of Violation to be served personally or by first class mailing to the Responsible Parties. The Notice shall be served on the Owner by mail to the address on the last assessment rolls of the City. If served on the Manager, it shall be mailed to the Manager's principal place of business. If served on any other Person, it shall be mailed to the Person's last known address. The Notice of violation shall be a public record subject to disclosure pursuant to Administrative Code Chapter 67.",
  },
  {
    sec: "Sec. 596 (e)(1).",
    text: "The Director shall specify in the Notice of Violation the time period within which the Responsible Party must abate the nuisance. Such time period shall not exceed 30 days, unless extended by the Director if reasonably necessary to abate the nuisance.",
  },
  {
    sec: "Sec. 596 (e)(3).",
    text: "If the Owner/Responsible Parties fail to comply with this Notice of Violation, the Director of Health may (A) hold a Director's Hearing to consider issuing a Director's Order to abate the nuisance or (B) cause the abatement and removal of the nuisance and the Owner shall be indebted to the City and County of San Francisco for all costs, charges and fees incurred.",
  },
  {
    sec: "Sec. 596 (e)(4).",
    text: "Owner/Responsible Parties may be liable for other charges, costs, including administrative costs, expenses incurred by the Department, fines, attorneys' fees, and penalties as provided for in Article 11.",
  },
  { header: true, sec: "LEGAL AUTHORITY" },
  {
    sec: "Sec. 595.",
    text: "Inspection of Premises. It shall be the duty of the Department of Public Health upon application from any person, firm, or corporation operating a hotel, before issuing the certificate specified in Section 594, to cause the premises to be inspected for purpose of ascertaining whether said premises are free of nuisances and are in a sanitary condition for human habitation.",
  },
  {
    sec: "Sec. 596 (a).",
    text: "Complaints. Whenever a written or oral complaint is made to the Department that a nuisance as defined by Section 581 exists, or the Director otherwise has reasonable cause to believe that such a nuisance exists, the Director shall inspect the building, structure or property to verify the existence of a nuisance thereon.",
  },
  { header: true, sec: "DEFINITIONS" },
  {
    sec: "Sec. 580 (a)",
    text: '"City" shall mean the City and County of San Francisco.',
  },
  {
    sec: "Sec. 580 (b)",
    text: '"Department" shall mean the San Francisco Department of Public Health.',
  },
  {
    sec: "Sec. 580 (c)",
    text: '"Director" shall mean the Director of Public Health or his or her designee.',
  },
  {
    sec: "Sec. 580 (d)",
    text: '"Manager" shall mean the authorized agent for the Owner of a building, structure or property, who is responsible for the day-to-day operation of said building, structure or property.',
  },
  {
    sec: "Sec. 580 (e)",
    text: '"Owner" shall mean any Person who possesses, has title to or an interest in, harbors or has control, custody or possession of any building, property, real estate, personality or chattel.',
  },
  {
    sec: "Sec. 580 (f)",
    text: '"Person" shall mean and include corporations, estates, associations, partnerships and trusts, one or more individual human beings, any department, Board or Commission of the City and County of San Francisco, and any agencies or instrumentalities of the State of California or the United States to the extent allowable by law.',
  },
  {
    sec: "Sec. 580 (h)",
    text: '"Responsible Party" shall include the Owner, Manager, tenant, or any Person having control over a property or who creates or allows or contributes to or fails to correct a condition that constitutes a nuisance as defined by this Article.',
  },
];
                ...
                <tr key={i}>
                  <td
                    ...
                    style={{
                      ...cellBold,
                      padding: "3px 6px",
                      background: row.dark ? "#d0d0d0" : "#f0f0f0",
                      fontStyle: "italic",
                    }}
                  >
                    {row.sec}
  ...
  return (
    ...
    >
        ...
        <tbody>
          <tr>
            <td style={{ ...cellBase, width: "55%" }}>
              <strong>Facility Address:</strong> {p.facilityName}
            </td>
            <td style={cellBase}>
              <strong>Inspection Date:</strong> {fmtDate(p.inspectionDate)}
            </td>
          </tr>
          <tr>
            <td style={cellBase}>
              <strong>Business Name:</strong> {p.reportTitle}
            </td>
            <td style={cellBase}>
              <strong>Reinspection Date:</strong> {fmtDate(reinspDate)}
            </td>
          </tr>
          <tr>
            <td style={cellBase}>
              <strong>Owner Name(s):</strong> {p.ownerName}
            </td>
            <td style={cellBase}>
              <strong>Inspection Type:</strong> {p.inspectionType}
            </td>
          </tr>
          <tr>
            <td style={cellBase}>
              <strong>Facility Type:</strong> {p.facilityType}&nbsp;&nbsp;&nbsp;
              <strong>Phone Number:</strong> {p.contactPhone}
            </td>
            <td style={cellBase}>
              <strong>Location ID:</strong> {p.locationId}
            </td>
      ...
      >
        ...
        <tbody>
          {filled.length === 0 ? (
            ...
            filled.map((v, i) => {
              const vt = VIOLATION_TYPES.find(
                (t) => `${t.category}||${t.label}` === v.violationKey,
              );
              // Resolve owner and tenant actions (new format with fallback to legacy)
              const ownerCAs =
                (v.ownerActions?.length ?? 0) > 0
                  ? (v.ownerActions ?? [])
                  : v.responsibleParty === "Owner" && v.correctiveAction
                    ? [v.correctiveAction]
                    : [];
              const tenantCAs =
                (v.tenantActions?.length ?? 0) > 0
                  ? (v.tenantActions ?? [])
                  : v.responsibleParty === "Tenant" && v.correctiveAction
                    ? [v.correctiveAction]
                    : [];
              return (
      ...
      >
        <tbody>
          <tr>
            <td style={{ ...cellBase, width: "50%", paddingTop: 12 }}>
              <strong>Inspector:</strong> {p.inspector}
            </td>
            <td style={{ ...cellBase, paddingTop: 12 }}>
          ...
          <tr>
            <td style={cellBase}>
              <strong>Phone:</strong> (415) 252-3800
            </td>
            <td style={cellBase}>
              <strong>Received By:</strong>
            </td>
