...
export default function NarrativeSection(p: NarrativeSectionProps) {
  ...
  const checkedCount =
    Object.values(p.checkedStandardCAs).filter(Boolean).length +
    p.customCAs.length;
                ...
                >
                  ...
                  <div className="col-span-7 space-y-1 w-full">
                    ...
                    <Textarea
                      ...
                      value={obs.text}
                      onChange={(e) => {
                        p.onObservationChange(obs.id, "text", e.target.value);
                        p.onAnyChange();
                      }}
                      ...
                      <SelectContent>
                        ...
                        {p.filledViolations.map((v) => {
                          const vType = VIOLATION_TYPES.find(
                            (t) =>
                              `${t.category}||${t.label}` === v.violationKey,
                          );
                          return vType ? (
                  ...
                  <div className="col-span-1 flex items-center justify-end sm:justify-center sm:pt-7">
                    {!p.isSubmitted && (
                      <button
                        type="button"
                        onClick={() => p.onRemoveObservation(obs.id)}
                ...
                <div key={cat}>
                  ...
                  <div className="space-y-2">
                    {suggestions.map((text) => {
                      ...
                      const details = p.standardCADetails[key] ?? {
                        date: "",
                        notes: "",
                      };
                      return (
                          ...
                          <div className="flex items-start gap-3 p-3">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => {
                                p.onToggleStandardCA(key, !!checked);
                                p.onAnyChange();
                              }}
                              className="mt-0.5"
                            />
                  ...
                  >
                    <div className="flex items-start gap-2">
                      ...
                      <Textarea
                        ...
                        value={ca.text}
                        onChange={(e) => {
                          p.onUpdateCustomCA(ca.id, "text", e.target.value);
                          p.onAnyChange();
                        }}
                        disabled={p.isSubmitted}
                      ...
                      {!p.isSubmitted && (
                        <button
                          type="button"
                          onClick={() => p.onRemoveCustomCA(ca.id)}
                    ...
                    <div className="grid grid-cols-2 gap-3 pl-7">
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          value={ca.date}
                          onChange={(e) => {
                            p.onUpdateCustomCA(ca.id, "date", e.target.value);
                            p.onAnyChange();
                          }}
                          disabled={p.isSubmitted}
                          className="h-8 text-sm"
                      ...
                      <div className="space-y-1">
                        ...
                        <Input
                          ...
                          value={ca.notes}
                          onChange={(e) => {
                            p.onUpdateCustomCA(ca.id, "notes", e.target.value);
                            p.onAnyChange();
                          }}
                          disabled={p.isSubmitted}
                          className="h-8 text-sm"
