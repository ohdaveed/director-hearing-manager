  ...
  return (
    <div className="packet-page print-page-break" style={{ fontFamily: 'Times New Roman, serif', fontSize: '11pt', lineHeight: 1.5 }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '20px', borderBottom: '2px solid black', paddingBottom: '12px' }}>
        ...
        <h2 style={{ fontSize: '14pt', fontWeight: 'black', textTransform: 'uppercase', letterSpacing: '0.08em', margin: '10px 0 4px' }}>
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '10.5pt' }}>
        <thead>
          <tr style={{ borderBottom: '2px solid black' }}>
            <th style={{ textAlign: 'left', padding: '4px 8px', width: '80px', fontWeight: 'bold', fontSize: '9pt', textTransform: 'uppercase' }}>Exhibit</th>
            <th style={{ textAlign: 'left', padding: '4px 8px', width: '100px', fontWeight: 'bold', fontSize: '9pt', textTransform: 'uppercase' }}>Date</th>
            <th style={{ textAlign: 'left', padding: '4px 8px', width: '120px', fontWeight: 'bold', fontSize: '9pt', textTransform: 'uppercase' }}>Type</th>
            <th style={{ textAlign: 'left', padding: '4px 8px', fontWeight: 'bold', fontSize: '9pt', textTransform: 'uppercase' }}>Description</th>
            <th style={{ textAlign: 'left', padding: '4px 8px', width: '80px', fontWeight: 'bold', fontSize: '9pt', textTransform: 'uppercase' }}>Pages</th>
          </tr>
        </thead>
        <tbody>
          {exhibits.map((ex, idx) => (
            <tr key={ex.id} style={{ borderBottom: '1px solid #ccc', verticalAlign: 'top' }}>
              ...
              <td style={{ padding: '6px 8px', fontSize: '10pt', whiteSpace: 'nowrap' }}>
                {fmt(ex.exhibitDate)}
              </td>
      ...
      <div style={{ marginTop: '24px', fontSize: '9pt', color: '#555' }}>
        <p>
          * Exhibits are labeled sequentially in the order they appear in this packet.
          Exhibit page references will be populated upon final packet generation.
        </p>
      </div>
