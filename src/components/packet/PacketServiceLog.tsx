    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center" }}>
          <PrintCheckbox checked={docNOV} /> Notice of Violation
        </div>
        <div style={{ display: "flex", alignItems: "center" }}>
          <PrintCheckbox checked={docBrief} /> SFDPH Hearing Brief
        </div>
        <div style={{ display: "flex", alignItems: "center" }}>
          <PrintCheckbox checked={docHearing} /> Notice of Hearing
        </div>
        <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          <PrintCheckbox checked={docOrder} /> Director's Hearing Order
        </div>
      </div>
      ...
      <div style={{ marginBottom: "12px", fontSize: "11pt" }}>
        ...
        >
          <span>
            Recipient Name <BlankLine width={150} />
          </span>
          <span>
            Signature <BlankLine width={150} />
          </span>
        </div>
      </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-start" }}>
          ...
          <span>
            ...
            <BlankLine
              width={200}
              value={
                isMethodChecked(method, "email")
                  ? (complaint?.hearingRpEmail ?? location?.owner_email ?? "")
                  : ""
              }
            />
          </span>
