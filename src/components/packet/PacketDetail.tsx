      ...
      <div className="px-5 pt-4 pb-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
          <Button
            ...
            data-testid="open-packet-preview"
          >
          ...
          <Button
            ...
            data-testid="packet-refresh-snapshot"
          >
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="w-full rounded-none border-b border-border bg-muted/30 h-10 px-4 justify-start gap-0.5 overflow-x-auto scrollbar-none">
          ...
          <TabsTrigger
            ...
            data-testid="packet-tab-readiness"
          >
            Readiness
          </TabsTrigger>
          <TabsTrigger
        ...
        <TabsContent
          ...
          data-testid="packet-readiness-tab"
        >
