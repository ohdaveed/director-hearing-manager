...
export function PacketEnforcementSummary({
  packet,
  complaint,
  location,
  inspections,
        ...
        >
          ...
          {firstPageCodes.length === 0 ? (
            <p style={{ fontSize: "9pt", color: "#555" }}>
              See attached inspection reports for applicable code sections.
            </p>
          ) : (
            <div>
        ...
        >
          ...
          <p style={{ fontWeight: "bold", margin: "0 0 2px", fontSize: "9pt" }}>
            <span style={{ display: "inline-flex", alignItems: "center" }}>
              ...
              >
                if case involves the Nuisance Code
              </em>
            </span>
          </p>
          <p
          ...
          <p style={{ fontWeight: "bold", margin: "0 0 2px", fontSize: "9pt" }}>
            <span style={{ display: "inline-flex", alignItems: "center" }}>
              ...
              >
                if the case involves a Health Permit
              </em>
            </span>
          </p>
          <p
          ...
          <p style={{ fontWeight: "bold", margin: "0 0 2px", fontSize: "9pt" }}>
            <span style={{ display: "inline-flex", alignItems: "center" }}>
              ...
              >
                if case involves a non-permitted facility and/or a penalty
              </em>
            </span>
          </p>
          <p
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={CELL}>
                  ...
                  {packet.program_code ?? ""}
                  {packet.case_number ? ` / ${packet.case_number}` : ""}
                </td>
              </tr>
            </tbody>
          </table>
