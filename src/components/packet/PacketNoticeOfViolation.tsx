...
function parseBlockLot(blockLot: string | undefined): {
  block: string;
  lot: string;
} {
...
export function PacketNoticeOfViolation({
  packet: _packet,
  complaint,
  location,
  inspections,
      ...
      <div className="packet-page print-page-break" style={baseStyle}>
        ...
        >
          <div>
            ...
            {ownerName && (
              <p style={{ margin: "0", fontWeight: "bold", fontSize: pt.body }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <p style={{ margin: "0", fontSize: pt.body }}>
              <strong>{S.dateLabel}</strong> {novDate}
            </p>
        ...
        <p style={{ margin: "0 0 12px", fontSize: pt.body }}>
          <strong>{S.propertyAddressLabel}</strong> {address}
          {dba ? ` — ${dba}` : ""}
        </p>
        ...
        <div style={{ fontSize: pt.contactBlock, marginTop: "auto" }}>
          ...
          {complaint?.legacy_complaint_id && (
            <p style={{ margin: "0 0 1px" }}>Complaint ID: {complaint.legacy_complaint_id}</p>
          )}
