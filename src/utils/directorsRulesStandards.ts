...
export const LANDSCAPE_CLEAR_DISTANCES: StandardEntry[] = [
  ...
  },
  {
    ...
    verbatimText:
      "Shrubs, vines and trees shall be trimmed to 3 feet away from the roof or balconies.",
  },
  {
    sourceSection: "Sec. VII-3 — Landscape Management",
...
export const MATERIAL_STORAGE_STACKING: StandardEntry[] = [
  ...
  },
  {
    ...
    shortTitle:
      "Container spec — rodent-proof, insect-vector-proof, watertight, tight-fitting lids",
    verbatimText:
...
export const BIOHAZARD_CHEMICAL_PROTOCOLS: StandardEntry[] = [
  ...
  },
  {
    sourceSection: "Sec. XIV — Procedures for Safe Cleanup",
    shortTitle:
      "Dead animal disposal — disinfect, double-bag in 2 plastic bags, covered garbage can",
    verbatimText:
...
const VIOLATION_STANDARDS_MAP: Array<{
...
}> = [
  {
    ...
    categories: [
      ...
      {
        name: "Material Storage & Stacking",
        entries: MATERIAL_STORAGE_STACKING,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    categories: [
      {
        name: "Biohazard & Chemical Protocols",
        entries: BIOHAZARD_CHEMICAL_PROTOCOLS,
      },
    ],
  },
  {
