...
- [x] Task: Audit current AI extraction logic and identify common failure points in PDF parsing. (Logic is currently missing/mocked in UI via apiService; Anthropic SDK installed but unused)
