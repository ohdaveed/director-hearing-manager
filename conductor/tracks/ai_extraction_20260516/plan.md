...
- [ ] Task: Audit current AI extraction logic and identify common failure points in PDF parsing.
- [ ] Task: Gather a dataset of "edge case" inspection reports for testing.
